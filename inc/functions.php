...
<div class="special-offer-container">
    ...
    <a href="<?php echo esc_attr( carbon_get_theme_option( 'special_offer_link' ) ) ?>" target="_blank" rel="nofollow">
        <div class="__icon">
        ...
        <div class="__label">
            <?php echo carbon_get_theme_option( 'special_offer_label_sticky' ); ?>
        </div>
    </a>
    <div class="__desc">
        <?php echo carbon_get_theme_option( 'special_offer_hover_desc' ); ?>
    </div>
</div>
        <?php 
